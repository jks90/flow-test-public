...
> [!NOTE]
> Manual de **flow-test v4.24.0** (imagen `juankanh/flow-app:4.24.0`). La imagen incluye Chromium para Captura, Live y `flow-explore` en modo crawl. Novedades de la 4.24: **pizarra** sobre el lienzo, barra lateral de iconos, **guía de nodos**, ocultar conectores y Mermaid a pantalla completa — ver [01](01-pantalla-principal.md) y [08](08-paneles.md).
...
8. [08 Paneles y utilidades](08-paneles.md) — **pizarra**, guía de nodos, historial, consola, batch, GitHub, export 🆕
