...
| **Lienzo** 🆕 4.26 | `node_focus`, `canvas_layout`, `whiteboard_update` | Centrar y resaltar un nodo, ordenar el lienzo (auto / fila / columna / colapsar / expandir) y dibujar en la pizarra |
