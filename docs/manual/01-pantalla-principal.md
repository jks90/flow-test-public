...
**Batch Run** (4.25.7), **Historial**, **Consola**, **Correo** 🆕 4.36 (servidor SMTP de prueba con buzones `@midominiotest.com`), **Vista** 🆕 4.27 (tamaño de los nodos, modo compacto y separación entre cajas), **SQL Conns**, **GitHub Flows**, **Variables** (del flow activo) y **Global** (compartidas entre flows), cada uno con su badge contador. Detalle en [08 Paneles y utilidades](08-paneles.md).
